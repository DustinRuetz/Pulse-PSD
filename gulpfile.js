...
const gulp = require("gulp"),
		...
		notify = require("gulp-notify"), // build tool - used to show tray notifications
		...
		doctoc = require("gulp-doctoc"); // documentation - automatic TOC in readme.md
...
// markupTasks
// 1) source: all HTML from dev/ pipes into...
// 2) inline: converts image SVGs to inline SVGs, then pipes into...
// 3) destination: public/ which then pipes into...
// 4) browsersync: reload the page with the updated markup
...
gulp.task("watchTasks", () => {
	...
	gulp.watch("dev/**/*.html", ["markupTasks"]);
